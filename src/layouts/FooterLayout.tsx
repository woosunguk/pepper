...
import { Bars3Icon, CheckCircleIcon, HomeIcon, PlusIcon, XMarkIcon } from '@heroicons/react/24/outline'
      ...
      <div className="flex flex-col flex-1 min-h-screen">
        <Layout>
          ...
          Get free delivery on orders over $100
            ...
            <nav className="flex px-8 py-2" aria-label="Breadcrumb">
            ...
            <div>
              <div className="px-4 py-2 rounded-md bg-green-50">
                <div className="flex">
        ...
        <footer className="bg-gray-300/30">
          <div className="px-4 py-2 mx-auto sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div className="mt-8 md:order-1 md:mt-0">
              <p className="text-xs text-center text-gray-400">&copy; 2022 Your Company, Inc. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
